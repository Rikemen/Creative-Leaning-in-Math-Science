...
- **Action:**
  ...
  - **Length:** Prefer a single-line commit comment of 100 characters or fewer.
  - **Body (optional):** Only add a body when explicitly requested, for breaking changes, migrations, or audit context. Wrap English at 72 chars.
