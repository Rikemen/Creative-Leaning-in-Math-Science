...
import { drawGrid, drawAxis, drawGraph, drawPointOnGraph, drawRemainderLine, drawTaylorAuxLines } from './drawing-utils.js';
...
function isMouseOverSlider() {
    ...
    // 少し余裕を持って判定範囲を設定
    return mouseX > CONFIG.style.canvasWidth - 230 &&
        mouseY > CONFIG.style.canvasHeight - 70;
}
